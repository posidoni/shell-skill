...
- Registry prep: `registry/agenticskills-submission.md` and `registry/awesome-codex-plugins-listing.md` are copy-ready drafts; live submission still needs maintainer email / opt-in scanner gate.
