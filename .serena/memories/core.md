...
- Registry prep: `REGISTRY.md` explains discovery surfaces and keeps copy-ready listing text; live submission still needs maintainer email / opt-in scanner gate.
